  ...
  return (
    <aside className="w-60 h-screen bg-gray-950 flex flex-col flex-shrink-0 border-r border-gray-800/60 overflow-y-auto">
      ...
      <div className="p-4 border-t border-gray-800/60 mt-4">
        ...
        <button
          onClick={onLogout}
          className="w-full flex items-center justify-center gap-2 px-3 py-2 rounded-lg bg-red-950/40 border border-red-800/40 text-red-300 text-xs font-semibold hover:bg-red-900/50 hover:text-red-100 transition-colors mb-2"
        >
